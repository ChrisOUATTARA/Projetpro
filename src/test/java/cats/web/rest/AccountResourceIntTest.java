package cats.web.rest;

import cats.MysqlsirApp;
import cats.config.Constants;
import cats.domain.Authority;
import cats.domain.PersistentToken;
import cats.domain.User;
import cats.repository.AuthorityRepository;
import cats.repository.PersistentTokenRepository;
import cats.repository.UserRepository;
import cats.security.AuthoritiesConstants;
import cats.service.MailService;
import cats.service.UserService;
import cats.service.dto.PasswordChangeDTO;
import cats.service.dto.UserDTO;
import cats.web.rest.errors.ExceptionTranslator;
import cats.web.rest.vm.KeyAndPasswordVM;
import cats.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = MysqlsirApp.class)
